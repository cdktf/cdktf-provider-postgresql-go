...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "alterObjectOwnership", GoGetter: "AlterObjectOwnership"},
			_jsii_.MemberProperty{JsiiProperty: "alterObjectOwnershipInput", GoGetter: "AlterObjectOwnershipInput"},
