...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataPostgresqlSchemas)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "includeSystemSchemas", GoGetter: "IncludeSystemSchemas"},
			_jsii_.MemberProperty{JsiiProperty: "includeSystemSchemasInput", GoGetter: "IncludeSystemSchemasInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeSystemSchemas", GoMethod: "ResetIncludeSystemSchemas"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-postgresql.dataPostgresqlSchemas.DataPostgresqlSchemasConfig",
		reflect.TypeOf((*DataPostgresqlSchemasConfig)(nil)).Elem(),
	)
}
