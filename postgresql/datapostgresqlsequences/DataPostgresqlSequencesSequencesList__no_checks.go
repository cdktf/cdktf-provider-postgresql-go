...
func (d *jsiiProxy_DataPostgresqlSequencesSequencesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataPostgresqlSequencesSequencesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataPostgresqlSequencesSequencesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataPostgresqlSequencesSequencesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
