...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v11/defaultprivileges/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.23.0/docs/resources/default_privileges postgresql_default_privileges}.
...
// Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.23.0/docs/resources/default_privileges postgresql_default_privileges} Resource.
...
func DefaultPrivileges_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDefaultPrivileges_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DefaultPrivileges) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DefaultPrivileges) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DefaultPrivileges) MoveFromId(id *string) {
...
func (d *jsiiProxy_DefaultPrivileges) MoveToId(id *string) {
