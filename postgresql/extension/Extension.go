...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v11/extension/internal"
...
func (j *jsiiProxy_Extension) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.21.0/docs/resources/extension postgresql_extension} Resource.
...
func (j *jsiiProxy_Extension)SetCreateCascade(val interface{}) {
	if err := j.validateSetCreateCascadeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_Extension)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func Extension_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_Extension) ImportFrom(id *string, provider cdktf.TerraformProvider) {
