...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parallel", GoGetter: "Parallel"},
			_jsii_.MemberProperty{JsiiProperty: "parallelInput", GoGetter: "ParallelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetParallel", GoMethod: "ResetParallel"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecurityDefiner", GoMethod: "ResetSecurityDefiner"},
			_jsii_.MemberMethod{JsiiMethod: "resetStrict", GoMethod: "ResetStrict"},
			_jsii_.MemberMethod{JsiiMethod: "resetVolatility", GoMethod: "ResetVolatility"},
			...
			_jsii_.MemberProperty{JsiiProperty: "securityDefiner", GoGetter: "SecurityDefiner"},
			_jsii_.MemberProperty{JsiiProperty: "securityDefinerInput", GoGetter: "SecurityDefinerInput"},
