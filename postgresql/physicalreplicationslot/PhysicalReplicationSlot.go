...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v11/physicalreplicationslot/internal"
...
// Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.23.0/docs/resources/physical_replication_slot postgresql_physical_replication_slot} Resource.
...
func (p *jsiiProxy_PhysicalReplicationSlot) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PhysicalReplicationSlot) MoveFromId(id *string) {
...
func (p *jsiiProxy_PhysicalReplicationSlot) MoveToId(id *string) {
