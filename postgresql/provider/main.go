...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "awsRdsIamProviderRoleArn", GoGetter: "AwsRdsIamProviderRoleArn"},
			_jsii_.MemberProperty{JsiiProperty: "awsRdsIamProviderRoleArnInput", GoGetter: "AwsRdsIamProviderRoleArnInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAwsRdsIamProviderRoleArn", GoMethod: "ResetAwsRdsIamProviderRoleArn"},
