...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v12/schema/internal"
...
func (s *jsiiProxy_SchemaPolicyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
