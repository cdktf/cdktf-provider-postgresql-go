...
func (s *jsiiProxy_Schema) validatePutPolicyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SchemaPolicy; received %#v (a %T)", value, value)
		}
	}
