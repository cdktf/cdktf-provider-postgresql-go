...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecurityLabel)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "labelProvider", GoGetter: "LabelProvider"},
			_jsii_.MemberProperty{JsiiProperty: "labelProviderInput", GoGetter: "LabelProviderInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-postgresql.securityLabel.SecurityLabelConfig",
		reflect.TypeOf((*SecurityLabelConfig)(nil)).Elem(),
	)
}
