...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v11/server/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.24.0/docs/resources/server postgresql_server}.
type Server interface {
	...
	ServerOwner() *string
	SetServerOwner(val *string)
	ServerOwnerInput() *string
	ServerType() *string
	SetServerType(val *string)
	ServerTypeInput() *string
	ServerVersion() *string
	SetServerVersion(val *string)
	ServerVersionInput() *string
	// Experimental.
...
func (j *jsiiProxy_Server) FdwName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fdwName",
...
func (j *jsiiProxy_Server) FdwNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fdwNameInput",
...
func (j *jsiiProxy_Server) Options() *map[string]*string {
...
func (j *jsiiProxy_Server) OptionsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"optionsInput",
...
func (j *jsiiProxy_Server) ServerName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverName",
...
func (j *jsiiProxy_Server) ServerNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverNameInput",
...
func (j *jsiiProxy_Server) ServerOwner() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverOwner",
...
func (j *jsiiProxy_Server) ServerOwnerInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverOwnerInput",
...
func (j *jsiiProxy_Server) ServerType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverType",
...
func (j *jsiiProxy_Server) ServerTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverTypeInput",
...
func (j *jsiiProxy_Server) ServerVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverVersion",
...
func (j *jsiiProxy_Server) ServerVersionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serverVersionInput",
...
// Create a new {@link https://registry.terraform.io/providers/cyrilgdn/postgresql/1.24.0/docs/resources/server postgresql_server} Resource.
...
func (s *jsiiProxy_Server) ResetDropCascade() {
	_jsii_.InvokeVoid(
		s,
		"resetDropCascade",
		nil, // no parameters
...
func (s *jsiiProxy_Server) ResetOptions() {
	_jsii_.InvokeVoid(
		s,
		"resetOptions",
		nil, // no parameters
...
func (s *jsiiProxy_Server) ResetServerOwner() {
	_jsii_.InvokeVoid(
		s,
		"resetServerOwner",
		nil, // no parameters
...
func (s *jsiiProxy_Server) ResetServerType() {
	_jsii_.InvokeVoid(
		s,
		"resetServerType",
		nil, // no parameters
...
func (s *jsiiProxy_Server) ResetServerVersion() {
	_jsii_.InvokeVoid(
		s,
		"resetServerVersion",
		nil, // no parameters
