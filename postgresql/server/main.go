...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "fdwName", GoGetter: "FdwName"},
			_jsii_.MemberProperty{JsiiProperty: "fdwNameInput", GoGetter: "FdwNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerOwner", GoMethod: "ResetServerOwner"},
			_jsii_.MemberMethod{JsiiMethod: "resetServerType", GoMethod: "ResetServerType"},
			_jsii_.MemberMethod{JsiiMethod: "resetServerVersion", GoMethod: "ResetServerVersion"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serverOwner", GoGetter: "ServerOwner"},
			_jsii_.MemberProperty{JsiiProperty: "serverOwnerInput", GoGetter: "ServerOwnerInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serverVersionInput", GoGetter: "ServerVersionInput"},
