...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "conninfo", GoGetter: "Conninfo"},
			_jsii_.MemberProperty{JsiiProperty: "conninfoInput", GoGetter: "ConninfoInput"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "createSlot", GoGetter: "CreateSlot"},
			_jsii_.MemberProperty{JsiiProperty: "createSlotInput", GoGetter: "CreateSlotInput"},
