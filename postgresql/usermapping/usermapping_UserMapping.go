...
import (
	...
	"github.com/cdktf/cdktf-provider-postgresql-go/postgresql/v4/usermapping/internal"
...
func (j *jsiiProxy_UserMapping) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UserMapping)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
